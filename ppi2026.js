...
const valorTotal = estoque
  .reduce((soma, product) => soma + product.price * product.qty, 0)
  .toFixed(2);

console.log(`Valor total: R$ ${valorTotal}`);

// b)
const nomes = estoque.map((product) => product.name);

const nomesCrescente = nomes.toSorted();
console.log("Nomes em ordem crescente:");
console.log(nomesCrescente);

const nomesDecrescente = nomesCrescente.toReversed();
console.log("Nomes em ordem decrescente:");
console.log(nomesDecrescente);

// c)
const precosCrescente = estoque.toSorted((a, b) => a.price - b.price);
console.log("Produtos por preço (crescente):");
console.log(precosCrescente);

const precosDecrescente = estoque.toSorted((a, b) => b.price - a.price);
console.log("Produtos por preço (decrescente):");
console.log(precosDecrescente);

// d)
const categoriaDesejada = "Tablet";
const produtosFiltrados = estoque.filter(
  (product) => product.category === categoriaDesejada,
);
